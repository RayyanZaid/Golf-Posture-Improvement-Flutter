...
class _HistoryPageState extends State<HistoryPage> {
  ...
  _loadHistory() async {
    // SharedPreferences has methods that can be used to set data of various primitive types in SharedPreferences
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            print(_history);
            // this line prints out all the stuff in the terminal
